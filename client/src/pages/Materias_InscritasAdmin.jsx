...
const Materias_InscritasAdmin = () => {
  ...
  const [comboboxPeriodo_MatI, setcomboboxPeriodo_MatI] = useState([]);
  const [comboboxMateria_MatI, setcomboboxMateria_MatI] = useState([]);
  ...
  const insertMaterias_Inscritas = () => {
    Axios.post("/insertMaterias_Inscritas", {
      alumno: alumnoInsert,
      ...
      <div className="container_tabla-AdminPages">
        <div className="containerheader-AdminPages">
          <div className="botones-AdminPages">
            ...
            <Button
              color="primary"
              onClick={() => navigate("/print/materias_inscritas")}
            >
              Imprimir
            </Button>
          </div>
          ...
          <ModalBody>
            ...
            <FormGroup>
              ...
              >
                ...
                {comboboxPeriodo_MatI.map((val, key) => {
            ...
            <FormGroup>
              ...
              >
                ...
                {comboboxMateria_MatI.map((val, key) => {
                  return (
                    <option value={val.ID}>
