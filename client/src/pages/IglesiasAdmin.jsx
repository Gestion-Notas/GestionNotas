...
const IglesiaAdmin = () => {
  ...
  const getIglesias = () => {
    Axios.get("http://localhost:4001/comboboxIglesia").then((response) => {
      setCbPastor(response.data);
    });
  };

  const insertPastor = () => {
    Axios.post("http://localhost:4001/insertIglesias", {
      nombre: nombreInsert,
  ...
  const execUpdate = (id) => {
    Axios.post("http://localhost:4001/getIglesiasUptade", {
      id: id,
    }).then((response) => {
  ...
  const updateIglesias = (id) => {
    Axios.put("http://localhost:4001/updateIglesias", {
      id: id,
      nombre: nombreUpdate,
